...
from zhugedanao.views_dir.threading_task_pachong import shouluORfugaiChaxun
from zhugedanao import models
import sys, time
import json

def shouluChaxun(lianjie, user_id, search):
    #     'shoulu': shoulu,
    #     'title': title,
    ...
    models.zhugedanao_shoulu_chaxun.objects.filter(user_id_id=user_id).update(
       is_shoulu = resultObj['shoulu'],
       title = resultObj['title'],
       kuaizhao_time = resultObj['kuaizhao_time'],
